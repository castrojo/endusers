...
Does your project run elections for things like a steering committee or TAB? If so, check out https://elekto.dev/ – a Cloud Native way to run elections inspired by the long-running CIVS project.
